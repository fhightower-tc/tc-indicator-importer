...
pack:
	...
	cp -r ./TCS_-_Unstructured_Indicator_Importer TCS_-_Unstructured_Indicator_Importer_app
	# zip the app (do it recursively (-r) and ignore any hidden mac files like '_MACOSX' and '.DS_STORE' (-X))
	zip -r -X TCS_-_Unstructured_Indicator_Importer.zip TCS_-_Unstructured_Indicator_Importer_app
	# remove the copy of this package
	rm -rf TCS_-_Unstructured_Indicator_Importer_app
